...
const { searchBuses, getBusLiveLocation, submitFeedback, getSchedule, getLiveBuses, getAllStops } = require("../controllers/passengerController");
const router = express.Router();

// search buses
router.get("/stops", authenticateUser, authorizeRole(["passenger"]), getAllStops);
